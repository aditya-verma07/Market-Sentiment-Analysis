...
# ---------- Step 1: Fetch news headlines from NewsAPI ----------
API_KEY = "e2f68c88e825448a8ce431e9dd70d590"  # replace with your NewsAPI key
TICKERS = {"Tesla": "Tesla", "BYD": "BYD"}  # queries for NewsAPI
...
# ---------- Step 4 (Optional): Fetch stock data ----------
...
byd_stock = fetch_stock_data('BYDDY')  # BYD ADR
